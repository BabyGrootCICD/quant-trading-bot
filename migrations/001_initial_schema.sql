-- 001: Initial schema for quant trading bot
-- Applied: 2026-08-23
...
CREATE POLICY "anon_all" ON candles FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "anon_all" ON features FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "anon_all" ON predictions FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "anon_all" ON paper_trades FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "anon_all" ON portfolio FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "anon_all" ON model_metrics FOR ALL USING (true) WITH CHECK (true);
